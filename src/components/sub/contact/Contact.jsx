	...
	const info = useRef([
		{
			...
			imgSrc: `${process.env.REACT_APP_PUBLIC_KEY}/img/marker1.png`,
		...
		},
		{
			...
			imgSrc: `${process.env.REACT_APP_PUBLIC_KEY}/img/marker2.png`,
			imgSize: new kakao.maps.Size(232, 99),
			imgPos: { offset: new kakao.maps.Point(116, 99) },
		},
		{
			...
			imgSrc: `${process.env.REACT_APP_PUBLIC_KEY}/img/marker3.png`,
			imgSize: new kakao.maps.Size(232, 99),
			imgPos: { offset: new kakao.maps.Point(116, 99) },
		},
	]);
